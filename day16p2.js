...
function searchThis(cell, targetCost, pathDirection) {
  // recursive function
  ...
  if (pathDirection == "north") {
    if (cell.north + 1 == targetCost) {
      searchFrom(cell, cell.north, "north")
    }

    if (cell.east + 1001 == targetCost) {
      searchFrom(cell, cell.east, "east")
    }

    if (cell.west + 1001 == targetCost) {
      searchFrom(cell, cell.west, "west")
    }
  ...
  if (pathDirection == "south") {
    if (cell.south + 1 == targetCost) {
      searchFrom(cell, cell.south, "south")
    }
